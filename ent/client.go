...
// QueryRoles queries the roles edge of a Customer.
func (c *CustomerClient) QueryRoles(cu *Customer) *RoleQuery {
...
// QueryCustomers queries the customers edge of a Role.
func (c *RoleClient) QueryCustomers(r *Role) *CustomerQuery {
...
type (
	hooks struct {
		Customer, Role []ent.Hook
	}
	inters struct {
		Customer, Role []ent.Interceptor
	}
)
