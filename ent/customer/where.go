...
// MembershipNum applies equality check predicate on the "membership_num" field. It's identical to MembershipNumEQ.
func MembershipNum(v int) predicate.Customer {
	return predicate.Customer(sql.FieldEQ(FieldMembershipNum, v))
}
...
// MembershipNumEQ applies the EQ predicate on the "membership_num" field.
func MembershipNumEQ(v int) predicate.Customer {
	return predicate.Customer(sql.FieldEQ(FieldMembershipNum, v))
}

// MembershipNumNEQ applies the NEQ predicate on the "membership_num" field.
func MembershipNumNEQ(v int) predicate.Customer {
	return predicate.Customer(sql.FieldNEQ(FieldMembershipNum, v))
}

// MembershipNumIn applies the In predicate on the "membership_num" field.
func MembershipNumIn(vs ...int) predicate.Customer {
	return predicate.Customer(sql.FieldIn(FieldMembershipNum, vs...))
}

// MembershipNumNotIn applies the NotIn predicate on the "membership_num" field.
func MembershipNumNotIn(vs ...int) predicate.Customer {
	return predicate.Customer(sql.FieldNotIn(FieldMembershipNum, vs...))
}

// MembershipNumGT applies the GT predicate on the "membership_num" field.
func MembershipNumGT(v int) predicate.Customer {
	return predicate.Customer(sql.FieldGT(FieldMembershipNum, v))
}

// MembershipNumGTE applies the GTE predicate on the "membership_num" field.
func MembershipNumGTE(v int) predicate.Customer {
	return predicate.Customer(sql.FieldGTE(FieldMembershipNum, v))
}

// MembershipNumLT applies the LT predicate on the "membership_num" field.
func MembershipNumLT(v int) predicate.Customer {
	return predicate.Customer(sql.FieldLT(FieldMembershipNum, v))
}

// MembershipNumLTE applies the LTE predicate on the "membership_num" field.
func MembershipNumLTE(v int) predicate.Customer {
	return predicate.Customer(sql.FieldLTE(FieldMembershipNum, v))
}
...
func HasRoles() predicate.Customer {
...
func HasRolesWith(preds ...predicate.Role) predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := newRolesStep()
